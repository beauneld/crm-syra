...
export default function Sidebar({ currentPage, onNavigate, onCollapseChange, onLogout, onProfileChange }: SidebarProps) {
  ...
  const managementItems = shouldShowManagement ? [
    { id: 'utilisateurs', label: 'Utilisateurs', icon: Users },
    { id: 'listes', label: 'Listes', icon: List },
    { id: 'performance', label: 'Performance', icon: TrendingUp },
  ] : [];

  const commissionsItems = shouldShowClients ? [
    { id: 'commissions-suivi', label: 'Suivi des Commissions', icon: BarChart3 },
    { id: 'commissions-fournisseurs', label: 'Paramétrage Fournisseurs', icon: Settings },
    { id: 'commissions-releves', label: 'Relevés Bancaires', icon: FileText },
    { id: 'commissions-statistiques', label: 'Statistiques', icon: TrendingUp },
    { id: 'commissions-bordereaux', label: 'Bordereaux', icon: FolderOpen },
  ] : [];
