/*
  # Mettre à jour les mémos avec des dates futures
  
  1. Objectif
    - Remplacer tous les mémos existants avec des dates futures
    - Garantir que les mémos s'affichent correctement dans le dashboard
    
  2. Mémos mis à jour (8 exemples)
    - Pièce manquante – Dossier MARTIN (21/11/2025 09:00)
    - Relance validation PER – GOASDOUE (22/11/2025 11:30)
    - Signature Assurance Vie – DUPONT (21/11/2025 14:00)
    - Programmer RDV bilan patrimonial (25/11/2025 10:00)
    - Mettre à jour procédure interne Bienviyance (27/11/2025 16:00)
    - Dossier en reprise – Mme LEROY (23/11/2025 18:00)
...
BEGIN
  ...
  IF admin_id IS NOT NULL THEN
    -- Delete all existing memos
    DELETE FROM memos WHERE organization_id = '1';

    -- Insert sample memos with future dates
    INSERT INTO memos (organization_id, user_id, title, description, due_date, due_time, status)
    VALUES
      ('1', admin_id, 'Pièce manquante – Dossier MARTIN', 'Attendre l''envoi du justificatif de domicile.', '2025-11-21', '09:00:00', 'pending'),
      ('1', admin_id, 'Relance validation PER – GOASDOUE', 'Relance téléphonique pour finaliser le contrat.', '2025-11-22', '11:30:00', 'pending'),
      ('1', admin_id, 'Signature Assurance Vie – DUPONT', 'Vérifier la signature électronique du dossier.', '2025-11-21', '14:00:00', 'pending'),
      ...
      ('1', admin_id, 'Dossier en reprise – Mme LEROY', 'Reprendre l''analyse (IBAN invalide).', '2025-11-23', '18:00:00', 'pending'),
